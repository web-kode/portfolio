...
export const Highlight = ({
  ...
  return (
    (<motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 shadow-md transition-all duration-300 ease-in-out transform hover:scale-105 dark:from-blue-600 dark:to-indigo-600 dark:hover:from-blue-700 dark:hover:to-indigo-700`,className
        // `relative inline-block rounded-lg bg-gradient-to-r from-sky-200 to-sky-300 px-1 pb-1 dark:from-sky-200 dark:to-sky-300`,className
      )}>
      {children}
    </motion.span>)
  );
